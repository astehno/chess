...
const workflowData = [
  ...
  },
  {
    ...
    { id: "4.3.7", name: "Rubble Mound: Low Crested Stability  **", colorVar: "var(--tier-4-color)", dashed: true },
    ...
    { id: "4.4.3", name: "NNBF: CSHORE-Veg", colorVar: "var(--tier-4-color)", dashed: true },
    ...
    { id: "4.5.7", name: "Waves: Boussinesq Modeling  **", colorVar: "var(--tier-4-color)", dashed: true },
    ...
    { id: "4.6.8", name: "Beaches: CSHORE", colorVar: "var(--tier-4-color)", dashed: true }
    ]
  },
  {
    ...
    subs: [
      ...
      { id: "5.3", name: "LCS Cost Analysis  **" },
      { id: "5.4", name: "Univariate: PST" },
      { id: "5.5", name: "Univariate: POT", dashed: true },
      { id: "5.6", name: "Univariate: MLM Fit", dashed: true },
      { id: "5.7", name: "Univariate: QQ Optimization", dashed: true },
      { id: "5.8", name: "Univariate: Bootstrap", dashed: true },
      { id: "5.9", name: "Multivariate: Correlation", dashed: true },
      { id: "5.10", name: "Multivariate: Copula", dashed: true },
      { id: "5.11", name: "Storm Sampling Tool", dashed: true},
      { id: "5.12", name: "CIRP Integration", dashed: true },
      { id: "5.13", name: "Water Level Detrending", dashed: true },
      { id: "5.14", name: "Non-Tidal Residual", dashed: true }
    ]
  },
  {
